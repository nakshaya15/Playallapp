  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-start justify-center text-white p-8 md:p-16">
      ...
      <div className="relative z-10 max-w-2xl mt-40">
        <p className="text-m uppercase tracking-wide font-bold mb-2 text-orange-400">Coaching That</p>
        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
          Creates The Players Of Tomorrow
        </h1>
        <a href="tel:9310096119" className="mt-6 inline-block bg-orange-500 text-white font-semibold py-2 px-6 rounded-md hover:bg-orange-600 transition-colors">
          Call Us @ 9310096119
        </a>
      </div>
