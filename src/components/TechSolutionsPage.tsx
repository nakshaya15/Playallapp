  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-start justify-center text-white p-8 md:p-16">
      <div className="absolute inset-0 z-0">
        ...
        <img
          src="/tech.jpg"
          alt="Digital sports solutions"
          className="w-full h-full object-cover"
        />
      </div>
      <div className="relative z-10 max-w-2xl mt-40">
        <p className="text-m uppercase tracking-wide font-bold mb-2 text-orange-400">Shaping Sports</p>
        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
          With Ultra-Modern Digital Products
        </h1>
        <a href="mailto:tech@playall.in" className="mt-6 inline-block bg-white text-orange-500 font-semibold py-2 px-6 rounded-full hover:bg-gray-200 transition-colors">
          EMAIL - TECH@PLAYALL.IN
        </a>
      </div>
